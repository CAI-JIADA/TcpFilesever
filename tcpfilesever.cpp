...
void TcpFilesever::acceptConnection()
{
    tcpServerConnection = tcpServer.nextPendingConnection();//取得已接受的客戶端連線
    connect (tcpServerConnection, SIGNAL (readyRead()),
            this, SLOT (updateServer Progress()));//連接readyRead()訊號至updateServerProgress()槽函數
...
void TcpFilesever::updateServerProgress()
{
...
void TcpFilesever::displayError(QAbstractSocket:: SocketError socketError)
{
